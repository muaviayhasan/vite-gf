...
class GetAQuoteNew extends Component {
  constructor(props) {
    super(props);
    this.state = {
      newProduct: [],
          ...
          <div className="row">
            ...
            <div className="col-md-8">
              ...
              <select
                ...
                class="custome-select-box-get-a-quote noborder changeColor"
              ...
              <React.Fragment>
                <div className="row">
                  ...
                  <div className="col-md-2 ">
                    <div className="form-group">
                      {designIndex == 0 ? (
                        <label className="custome_lable custo">Cutouts</label>
                      ) : (
                        ""
                      )}
                      <input
                  ...
                  <div className="col-md-1 ">
                    <div className="form-group Designtable">
                      {designIndex == 0 ? (
                        <label className="custome_lable">Shaped</label>
                      ) : (
                        ""
                      )}
          ...
          <React.Fragment key={indexofSplash}>
            <div className="row">
              <div className="col-md-4">
                <div className="form-group">
                  {indexofSplash == 0 ? (
                    <label className="custome_lable pdfLabel">Item</label>
                  ) : (
                    ""
                  )}
          ...
          <div className="row">
            ...
            <div className="col-md-2" style={{ maxHeight: "15px" }}>
              {index == 0 ? (
                ...
                <div className="form-group p-0 m-0 mt-1">
                  <button
                    type="button"
                    className="Green-Add-Panel_button noprint"
                    key="add"
        ...
        <React.Fragment key={index}>
          <div className="row">
            ...
            <div className="col-md-1 cust-marg-get-a-quote">
              <div className="form-group">
                {index == 0 ? (
                  <label className="custome_lable">UnitPrice</label>
                ) : (
                  ""
                )}
              ...
              <div className="container">
                  ...
                  {auth.isAuthenticatedAdmin() ? (
                    <React.Fragment>
                      ...
                      >
                        ...
                        >
                          Step 11: Add New Product to Quote
                          {auth.isAuthenticatedAdmin() &&
                    ...
                    <div className="container">
                      ...
                      {this.state.stoneProduct ? (
                        <React.Fragment>
                          ...
                          >
                            Step 2: Measurements & Price Estimator (Quartz,
                            Marble, Granite, Compact Worktops)
                          </span>
                                ...
                                <div className="col-md-8 ">
                                  <div className="form-group">
                                    ...
                                    <select
                                      ...
                                      class="custome-select-box-get-a-quote noborder"
                      ...
                      {this.state.glassProduct ? (
                        <React.Fragment>
                          ...
                          >
                            Step 2: Measurements & Bespoke Glass Price Estimator
                          </span>
                          <div
                            className="container"
                              ...
                              <div className="col-md-6 col-sm-12 custome_table_get_a_quote">
                                <div className="row radio-margin ">
                                  ...
                                  <div
                                    ...
                                    style={{ marginLeft: "-9%" }}
                                  >
                                    <label class="radio-inline2 noprint">
                                      <input
                                        type="radio"
                                        name="optradio"
                                        id="no"
                                  ...
                                  <div className="col-md-3 font-class">
                                  ...
                                  <div className="col-md-3">
                                    <select
                                      ...
                                      class="select-box-survey-fit noborder changeColor"
                                ...
                                <div className="padding-class font-class-extra-service">
                                  Extra Services
                                  {html5}
                                </div>
                              </div>
                ...
                >
                  {auth.isAuthenticatedAdmin() ? (
                    ...
                    >
                      Step 3: Customer Search (Optional)
                      {this.state.customers.length > 0 ? (
                        <Select
                          closeMenuOnSelect={true}
                          options={this.state.customers}
                ...
                <div class="row" style={{ marginLeft: "0%" }}>
                  ...
                  >
                    Step {auth.isAuthenticatedAdmin() ? "4" : "3"}: Client's
                    Information
                  </span>
                </div>
                ...
                >
                  <div className="row col-md-12 col-lg-12 ">
                    <div className="col-md-4 col-lg-3 col-sm-12 ">
                      <div className="form-group">
                        <label className="custome_lable">First Name</label>
                        <input
                          type="text"
                    ...
                    <div className="col-md-4 col-lg-3 col-sm-12 ">
                      <div className="form-group">
                        <label className="custome_lable">Last Name</label>
                        <input
                          type="text"
                    ...
                    <div className="col-md-4 col-lg-3 col-sm-12 ">
                      <div className="form-group">
                        <label className="custome_lable">Email</label>
                        <input
                          type="email"
                          placeholder="Email"
                          className="form-control custom-text_cutouts noborder"
                    ...
                    <div className="col-md-4 col-lg-3 col-sm-12 ">
                      <div className="form-group">
                        <label className="custome_lable">Phone Number</label>
                        <input
                          type="text"
                    ...
                    {auth.isAuthenticatedAdmin() && (
                      <Fragment>
                        <div className="col-md-4 col-lg-3 col-sm-12 ">
                          <div className="form-group">
                            <label className="custome_lable">Address</label>
                            <input
                              type="text"
                              placeholder="Address"
                              className="form-control custom-text_cutouts noborder"
                        ...
                        <div className="col-md-4 col-lg-3 col-sm-12 ">
                          <div className="form-group">
                            <label className="custome_lable">Post Code</label>
                            <input
                              type="text"
                        ...
                        <div className="col-md-4 col-lg-3 col-sm-12 ">
                          <div className="form-group">
                            <label className="custome_lable">City</label>
                            <input
                              type="text"
                              placeholder="City"
                              className="form-control custom-text_cutouts noborder"
                ...
                <div>
                  <div className="col-md-12" style={{ marginLeft: "-2%" }}>
                    <span
                      className="font-12"
                      style={{ "font-size": "20px", fontWeight: "normal" }}
                    >
                      Step {auth.isAuthenticatedAdmin() ? "5" : "4"}: Get your
                      FREE Quote
                    </span>

...
class Search extends Component {
  ...
  async componentDidMount() {
    if (this.props.location.state) {
      let searchCriteria = {
        searchCriteria: this.props.location.state.searchData,
        limit: this.state.limit,
      ...
      if (this.props.location.state.searchData.currentMaterial === "Glass") {
        this.setState({
          ...this.state,
          glass_category: this.props.location.state.searchData.glass_category,
          glassProductName: this.props.location.state.searchData.product_name,
          base_color: this.props.location.state.searchData.base_color,
          price_band: this.props.location.state.searchData.price_band,
          currentMaterial: this.props.location.state.searchData.currentMaterial,
        });
      } else if (
        this.props.location.state.searchData.currentMaterial === "Stone"
      ) {
        this.setState({
          ...this.state,
          material_type: this.props.location.state.searchData.stone_material,
          effect: this.props.location.state.searchData.effect,
          base_color: this.props.location.state.searchData.base_color,
          price_band: this.props.location.state.searchData.price_band,
          brand: this.props.location.state.searchData.brand,
          currentMaterial: this.props.location.state.searchData.currentMaterial,
        });
      }
    }
              ...
              <div className="row seven-cols">
                ...
                <div className="col-lg-1 col-md-3 col-sm-4 col-xs-6">
                  <div>
                    <button
                      type="button"
                      className="btn btn-primary btn-sm btn-p"
        ...
        <div className="container">
          ...
          <div className="  search-product">
            <div className="row col-md-12">
              {obj.state.items.map(function(product, index) {
                n = n + 1;
                return (
                  <Fragment>
                    <div
                          ...
                          <p>
                            ...
                            >
                              ...
                              <div className="col-5">
                                ...
                                >
                                  {parse(
                                    obj.getPriceRange(product.finishes, "price")
                                  )}
                                </p>
                              </div>
                            </div>

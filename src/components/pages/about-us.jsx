                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="banner-section">
                                    <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/about/about%20us.jpg`} className="img-fluid" alt=""/>
                                </div>
                            </div>
                            ...
                            <div className="col-sm-12">
                                <Slider {...Slider2} className="slide-2 testimonial-slider no-arrow">
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/avtar.jpg`} alt="#" />
                                                    <h5>Mark Jecno</h5>
                                                    <h6>Designer</h6>
                                            </div>
                                    ...
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/2.jpg`} alt="#" />
                                                    <h5>Mark Jecno</h5>
                                                    <h6>Designer</h6>
                                            </div>
                                            <div className="media-body">
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                ...
                                <Slider {...Team4} className="team-4">
                                    <div>
                                        <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/team/1.jpg`} className="img-fluid" alt=""/>
                                        <h4>Hileri Keol</h4>
                                        <h6>CEo & Founder At Company</h6>
                                    </div>
                                    <div>
                                        <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/team/2.jpg`} className="img-fluid" alt=""/>
                                        <h4>Hileri Keol</h4>
                                        <h6>CEo & Founder At Company</h6>
                                    </div>
                                    <div>
                                        <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/team/3.jpg`} className="img-fluid" alt=""/>
                                        <h4>Hileri Keol</h4>
                                        <h6>CEo & Founder At Company</h6>
                                    </div>
                                    <div>
                                        <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/team/4.jpg`} className="img-fluid" alt=""/>
                                        <h4>Hileri Keol</h4>
                                        <h6>CEo & Founder At Company</h6>
                                    </div>
                                    <div>

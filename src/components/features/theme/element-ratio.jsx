                                ...
                                <Slider {...Product4} className="product-4 product-m no-arrow">
                                        ...
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html">
                                                    <img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/pro3/27.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="back">
                                                <a href="product-page(no-sidebar).html">
                                                    <img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/pro3/28.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                        ...
                                        <div className="img-wrapper">
                                            ...
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/pro3/1.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/pro3/2.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/pro3/33.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/pro3/34.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart">
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            ...
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/pro3/35.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/pro3/36.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart">
                                ...
                                <Slider {...Product4} className="no-slider row">
                                    <div className="product-box ">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/gym/pro/1.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                    ...
                                    <div className="product-box ">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/gym/pro/2.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div className="product-box ">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/gym/pro/3.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div className="product-box ">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/gym/pro/4.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                ...
                                <Slider {...Product4} className="product-4 product-m no-arrow">
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/fashion/pro/1.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/fashion/pro/2.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button title="Add to cart"><i className="fa fa-shopping-cart"></i></button>
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/fashion/pro/3.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button title="Add to cart"><i className="fa fa-shopping-cart"></i></button>
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                    src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/fashion/pro/4.jpg`}
                                                    className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                                <button title="Add to cart"><i className="fa fa-shopping-cart"></i></button>
                            ...
                            <div className="col">
                                <Slider {...Product4} className="product-4 product-m no-arrow">
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/game/pro/11.jpg`}
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            ...
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/game/pro/12.jpg`}
                                                                                             className="bg-img img-fluid blur-up lazyload"
                                                                                             alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/game/pro/13.jpg`}
                                                                                             className="bg-img img-fluid blur-up lazyload"
                                                                                             alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            ...
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/game/pro/14.jpg`}
                                                                                             className="bg-img img-fluid blur-up lazyload"
                                                                                             alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">
                                    ...
                                    <div className="product-box">
                                        <div className="img-wrapper">
                                            ...
                                            <div className="front">
                                                <a href="product-page(no-sidebar).html"><img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/game/pro/15.jpg`}
                                                                                             className="bg-img img-fluid blur-up lazyload"
                                                                                             alt="" /></a>
                                            </div>
                                            <div className="cart-info cart-wrap">

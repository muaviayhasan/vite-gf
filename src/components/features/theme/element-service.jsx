                    ...
                    <section className="service border-section small-section ">
                        <div className="row">
                            <div className="col-md-4 service-block">
                                <div className="media">
                                    <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/service1.png`} alt=""/>
                            ...
                            <div className="col-md-4 service-block">
                                <div className="media">
                                    <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/service2.png`} alt=""/>
                                    <div className="media-body">
                            ...
                            <div className="col-md-4 service-block">
                                <div className="media">
                                    <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/service3.png`} alt=""/>
                                    <div className="media-body">

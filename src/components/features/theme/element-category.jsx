                            ...
                            <div className="col">
                                <Slider {...Slider6} className="slide-6 no-arrow">
                                    <div className="category-block">
                                        <a href="#">
                                            <div className="category-image">
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/cat1.png`} alt="" /></div>
                                        </a>
                                    ...
                                    <div className="category-block">
                                        <a href="#">
                                            <div className="category-image">
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/cat2.png`} alt="" /></div>
                                        </a>
                                        <div className="category-details">
                                            <a href="#">
                                                <h5>casual shoes</h5>
                                    ...
                                    <div className="category-block">
                                        <a href="#">
                                            <div className="category-image">
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/cat3.png`} alt="" /></div>
                                        </a>
                                        <div className="category-details">
                                            <a href="#">
                                                <h5>formal shoes</h5>
                                    ...
                                    <div className="category-block">
                                        <a href="#">
                                            <div className="category-image">
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/cat4.png`} alt="" /></div>
                                        </a>
                                        <div className="category-details">
                                            <a href="#">
                                                <h5>flat</h5>
                                    ...
                                    <div className="category-block">
                                        <a href="#">
                                            <div className="category-image">
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/cat5.png`} alt="" /></div>
                                        </a>
                                        <div className="category-details">
                                            <a href="#">
                                                <h5>heels</h5>
                                    ...
                                    <div className="category-block">
                                        <a href="#">
                                            <div className="category-image">
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/cat6.png`} alt="" /></div>
                                        </a>
                                        <div className="category-details">
                                            <a href="#">
                                                <h5>boots</h5>
                        ...
                        <div className="row category-border">
                            <div className="col-sm-4 border-padding">
                                <div className="category-banner">
                                    <div>
                                        <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/cat1.png`} className="img-fluid blur-up lazyload bg-img"
                                             alt="" />
                                    </div>
                            ...
                            <div className="col-sm-4 border-padding">
                                <div className="category-banner">
                                    <div>
                                        <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/cat2.png`} className="img-fluid blur-up lazyload bg-img"
                                             alt="" />
                                    </div>
                                    <div className="category-box">
                                        <a href="#">
                            ...
                            <div className="col-sm-4 border-padding">
                                <div className="category-banner">
                                    <div>
                                        <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/cat3.png`} className="img-fluid blur-up lazyload bg-img"
                                             alt="" />
                                    </div>
                                    <div className="category-box">
                                        <a href="#">
                        ...
                        <div className="row order-section">
                            <div className="col-sm-4 p-0">
                                <a href="#" className="image-block">
                                    <img alt="" src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/cat1.jpg`} className="img-fluid blur-up lazyload bg-img" />
                                </a>
                            </div>
                            <div className="col-sm-4 p-0">
                            ...
                            <div className="col-sm-4 p-0">
                                <a href="#" className="image-block">
                                    <img alt="" src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/cat2.jpg`} className="img-fluid blur-up lazyload bg-img" /></a>
                            </div>
                            <div className="col-sm-4 p-0">
                            ...
                            <div className="col-sm-4 p-0">
                                <a href="#" className="image-block even">
                                    <img alt="" src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/cat3.jpg`} className="img-fluid blur-up lazyload bg-img" /></a>
                            </div>
                            <div className="col-sm-4 p-0">
                                <div className="contain-block">
                                    <div>
                                ...
                                <Slider {...Slider4} className="slide-4 category-m no-arrow">
                                    <div>
                                        <div className="category-wrapper">
                                            <div>
                                                <div>
                                                    <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/watch/cat1.png`}
                                    ...
                                    <div>
                                        <div className="category-wrapper">
                                            <div>
                                                <div>
                                                    <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/watch/cat2.png`}
                                                         className="img-fluid blur-up lazyload bg-img" alt="" />
                                                </div>
                                    ...
                                    <div className="category-wrapper">
                                        <div>
                                            <div>
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/watch/cat3.png`}
                                                     className="img-fluid blur-up lazyload bg-img" alt="" />
                                            </div>

        ...
        return (
            ...
            <div className="product-box product-wrap">
                <div className="img-wrapper">
                    ...
                    <div className="front">
                        <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${product.id}`} ><img
                    ...
                    <div className="cart-box">
                        ...
                        {/* compare */}
                        {/* <Link to={`${import.meta.env.VITE_PUBLIC_URL}/compare`} title="Compare" onClick={onAddToCompareClicked}> */}
                ...
                <div className="product-detail  text-center">
                    <div>
                        ...
                        <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${product.id}`}>
                            <h6>{product.name}</h6>
                        </Link>
                                    ...
                                    <div className="col-lg-6 rtl-text">
                                        <div className="product-right">
                                            ...
                                            <div className="product-buttons">
                                                ...
                                                <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${product.id}`} className="btn btn-solid">view detail</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>

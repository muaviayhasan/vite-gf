            ...
            <div className="col-lg-6 rtl-text">
                <div className="product-right">
                                    ...
                                    <div className="modal-dialog modal-dialog-centered"
                                        ...
                                        <div className="modal-content">
                                            ...
                                            <div className="modal-body">
                                                <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/size-chart.jpg`} alt="" className="img-fluid"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="product-buttons" >
                        ...
                        <Link to={`${import.meta.env.VITE_PUBLIC_URL}/checkout`} className="btn btn-solid" onClick={() => BuynowClicked(item, this.state.quantity)} >buy now</Link>
                    </div>

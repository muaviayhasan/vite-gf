    ...
    render (){
        ...
        return (
            <div>
                {/*SEO Support*/}
                <Helmet>
                    <title>Glass &amp; Fusion | Cart List Page</title>
                    <meta name="description" content="Glass &amp; Fusion" />
                </Helmet>
                {/*SEO Support End */}
                ...
                <section className="cart-section section-b-space">
                    <div className="container">
                                ...
                                <table className="table cart-table table-responsive-xs">
                                    ...
                                    {cartItems.map((item, index) => {
                                        ...
                                        <tbody key={index}>
                                            <tr>
                                                <td>
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${item.id}`}>
                                                        <img src={item.variants?
                                                                  item.variants[0].images
                                                                  :item.pictures[0]} alt="" />
                                                    </Link>
                                                </td>
                                                <td><Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${item.id}`}>{item.name}</Link>
                        ...
                        <div className="row cart-buttons">
                            <div className="col-6">
                                <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/collection`} className="btn btn-solid">continue shopping</Link>
                            </div>
                            <div className="col-6">
                                <Link to={`${import.meta.env.VITE_PUBLIC_URL}/checkout`} className="btn btn-solid">check out</Link>
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="col-sm-12">
                                <div >
                                    <div className="col-sm-12 empty-cart-cls text-center">
                                        <img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon-empty-cart.png`} className="img-fluid mb-4" alt="" />
                                        <h3>

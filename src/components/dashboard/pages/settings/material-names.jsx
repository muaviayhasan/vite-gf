...
class MaterialNames extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            isLoaded: false,
    ...
    componentDidMount() {
    axios.get(`${import.meta.env.VITE_API_URL}/materials`).then(res => {
      this.setState({
    ...
    let fields = [
      {
        ...
        name: "name",
        value: "",
        placeholder: "Material Names"
      }
        
    ];
    let columns = [
      { title: "Material Names", field: "name" }
    ];
        return ( 
              <div>
            ...
            <div className="col-md-9" style={{ "margin-top": "20px" }}>
              <main className="page-content">
                <div className="container-fluid">
                  <h1 className="heading-settings-table">Material Names</h1>
                  {isLoaded ? (
                    <FormTamplate
                      fields={fields}
                      ...
                      columns={columns}
                      data={data}
                      saveUrl={`${import.meta.env.VITE_API_URL}/materials`}
                      updateUrl={`${import.meta.env.VITE_API_URL}/materials/update`}
                      deleteUrl={`${import.meta.env.VITE_API_URL}/materials/delete`}
                    />
                  ) : (
                    ""
                  )}

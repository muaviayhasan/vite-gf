...
class EdgeDetailOptions extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoaded: false,
  ...
  render() {
    ...
    let fields = [
      ...
      },
      {
        ...
        name: "name",
        value: "",
        placeholder: "Edge Detail"
      }
    ];
    let columns = [
      { title: "Material", field: "materialType.name" },
      { title: "Edge Detail Options", field: "name" }
    ];
    return (
      <div>
            ...
            <div className="col-md-9" style={{ "margin-top": "20px" }}>
              <main className="page-content">
                <div className="container-fluid">
                  <h1 className="heading-settings-table">Edge detail options</h1>
                  {isLoaded ? (
                    <FormTamplate
                      fields={fields}
                      title="Edge detail options"
                      columns={columns}
                      data={data}
                      saveUrl={`${import.meta.env.VITE_API_URL}/edge-details`}
                      updateUrl={`${import.meta.env.VITE_API_URL}/edge-details/update`}
                      deleteUrl={`${import.meta.env.VITE_API_URL}/edge-details/delete`}
                    />
                  ) : (
                    ""
                  )}
...
export default EdgeDetailOptions;

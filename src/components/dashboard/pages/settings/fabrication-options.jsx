...
class FacbricationOptions extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoaded: false,
  ...
  render() {
    ...
    let fields = [
      ...
      },
      {
        ...
        name: "name",
        value: "",
        placeholder: "Fabrication Options"
      },
      {
        type: "text",
        name: "price",
    ...
    let columns = [
      ...
      { title: "Fabrication Options", field: "name" },
            ...
            <div className="col-md-9" style={{ "margin-top": "20px" }}>
              <main className="page-content">
                <div className="container-fluid">
                  <h1 className="heading-settings-table">Fabrication Options</h1>
                  {isLoaded ? (
                    <FormTamplate
                      fields={fields}
                      ...
                      columns={columns}
                      data={data}
                      saveUrl={`${import.meta.env.VITE_API_URL}/fabrication_options`}
                      updateUrl={`${import.meta.env.VITE_API_URL}/fabrication_options/update`}
                      deleteUrl={`${import.meta.env.VITE_API_URL}/fabrication_options/delete`}
                    />
                  ) : (
                    ""
                  )}
...
export default FacbricationOptions;

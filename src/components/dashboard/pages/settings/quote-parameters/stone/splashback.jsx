                ...
                <div className="container-fluid">
                  ...
                  {isLoaded ? (
                    <FormTamplate
                      ...
                      columns={columns}
                      data={data}
                      saveUrl={`${import.meta.env.VITE_API_URL}/splashback-dimensions`}
                      updateUrl={`${import.meta.env.VITE_API_URL}/splashback-dimensions/update`}
                      deleteUrl={`${import.meta.env.VITE_API_URL}/splashback-dimensions/delete`}
                    />
                  ) : (
                    ""
                  )}

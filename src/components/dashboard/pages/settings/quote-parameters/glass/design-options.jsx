...
class DesignOptions extends Component {
  ...
  render() {
    ...
    let columns = [
      ...
      { title: "Design Options", field: "name" }
    ];
    return (
      <div>
            ...
            <div className="col-md-9" style={{ "margin-top": "20px" }}>
              <main className="page-content">
                <div className="container-fluid">
                  <h2 className="heading-settings-table">Design Options</h2> <br />
                  {isLoaded ? (
                    <FormTamplate
                      fields={fields}
                      ...
                      columns={columns}
                      data={data}
                      saveUrl={`${import.meta.env.VITE_API_URL}/design_options`}
                      updateUrl={`${import.meta.env.VITE_API_URL}/design_options/update`}
                      deleteUrl={`${import.meta.env.VITE_API_URL}/design_options/delete`}
                    />
                  ) : (
                    ""
                  )}

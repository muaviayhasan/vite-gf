...
class BookAppointment extends Component{
    ...
    constructor(props) {
      ...
      formSubmitHandler = async payload => {
        ...
        const res = await axios.post(
          `${import.meta.env.VITE_API_URL}/book-an-appointment`,
          payload
        );
        console.log(res);
    ...
    render() {
        ...
        return(
            <div className="main">
                <Helmet>
                    <title>GNF - Book an Appointment</title>
                </Helmet>
                
                <h1 className="d-none">GNF - Book an Appointment</h1>

                <Breadcrumb title="Book an Appointment" adClass="border-0 mb-0"/>
                           
                <div className="container">
                <h1 className="page-title" style={{fontSize: '25px'}}>Book an Appointment</h1>
                </div>
<br/>
                    ...
                    <div className="container">
                        <div className="row" style={{display: 'flex', justifyContent: 'center'}}>
                            <div className="col-lg-6">
                                ...
                                <p className="mb-2">Use the form below to book an appointment
</p>

                                <form action="#" className="contact-form mb-3">
                                    <div className="row">
                                        <div className="col-sm-12">
                                            <label htmlFor="cname" className="sr-only">Name</label><br/>
                                            {name === "" && loading && (
                        ...
                        {phone === "" && loading && (
                          <span className="error text-danger">
                            Phone is required*
                                            ...
                                            <input type="tel" className="form-control" id="cphone" placeholder="Phone *" required
                          name="phone"
                          value={phone}
                          onChange={this._handleChange}/>
                                        </div>
                                    ...
                                    <label htmlFor="cmessage" className="sr-only">Message</label><br />
                        {message === "" && loading && (
                          <span className="error text-danger">
                            Message is required*
                          </span>
                        )}
                                    <textarea className="form-control" cols="30" rows="4" id="cmessage" required name="message"
                          value={message}
                          onChange={this._handleChange} placeholder="Message *"></textarea>

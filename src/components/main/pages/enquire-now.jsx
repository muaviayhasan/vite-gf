...
class EnquireNow extends Component {
  ...
  submit = (e) => {
    ...
    const { checked, name, productUrl, email, phone, message } = this.state;
    if (
      checked &&
      name !== "" &&
      productUrl !== "" &&
  ...
  render() {
    ...
    return (
      <div className="main">
        <Helmet>
          <title>GNF - Enquire Product</title>
        </Helmet>

        <h1 className="d-none">GNF - Enquire Product</h1>

        <Breadcrumb title="Enquire Product" adClass="border-0 mb-0" />
          ...
          <div className="container">
            ...
            >
              <div className="col-lg-6">
                ...
                <p className="mb-2">Use the form below to enquire product</p>

...
class Page extends Component {
  ...
  formSubmitHandler = async (payload) => {
    ...
    const res = await axios.post(
      `${import.meta.env.VITE_API_URL}/book-home-visit`,
      payload
    );
    this.props.history.push("/book-home-visit-thank-you-page");
    console.log(res);
  ...
  submit = (e) => {
    ...
    const { checked, name, email, date, phone, address, message } = this.state;
    if (
      checked &&
      name !== "" &&
      email !== "" &&
  ...
  render() {
    ...
    return (
      <div className="main">
        <Helmet>
          <title>GNF - Book Home Visit</title>
        </Helmet>

        <h1 className="d-none">GNF - Book Home Visit</h1>
          ...
          <div className="container">
            ...
            >
              <div className="col-lg-6">
                ...
                <p className="mb-2">Use the form below to book home visit</p>

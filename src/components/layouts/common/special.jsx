                                        ...
                                        <div className="offer-slider">
                                            <div className="sec-1">
                                                <div className="product-box2">
                                                    <div className="media">
                                                        <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${product[0].id}`} >
                                                            <img
                                                ...
                                                <div className="product-box2">
                                                    <div className="media">
                                                        <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${product[1].id}`} >
                                                            <img
                                                                className="img-fluid blur-up lazyload"
                                    ...
                                    <div className="theme-card center-align">
                                        <div className="offer-slider">
                                            <div className="sec-1">
                                                <div className="product-box2">
                                                    <div className="media">
                                                        <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${product[3].id}`} >
                                                            <img
                                                                className="img-fluid blur-up lazyload"
                                                ...
                                                <div className="product-box2">
                                                    <div className="media">
                                                        <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${product[4].id}`} >
                                                            <img
                                                                className="img-fluid blur-up lazyload"

                        ...
                        <div key={index}>
                            {products.map((product, i) =>
                                <div className="media" key={i}>
                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${product.id}`}><img className="img-fluid" src={`${product.variants[0].images}`} alt="" /></Link>
                                    <div className="media-body align-self-center">
                                        ...
                                        <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/${product.id}`}><h6>{product.name}</h6></Link>

                      ...
                      <div className="icon-nav">
                        <ul>
                          <li className="onhover-div mobile-search">
                            <div>
                              <img
                                src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/search.png`}
                          ...
                          {/* <li className="onhover-div mobile-setting">
                                                        <div><img src={`${import.meta.env.VITE_PUBLIC_URL}/assets/images/icon/setting.png`} className="img-fluid" alt="" />
...
export default connect(null, { changeCurrency })(HeaderThree);

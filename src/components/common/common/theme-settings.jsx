...
class ThemeSettings extends Component {
    ...
    changeColor(event, color){
        ...
        console.log(color)
        document.getElementById("color").setAttribute("href", `${import.meta.env.VITE_PUBLIC_URL}/assets/css/`+color+`.css` );
    }
                                        ...
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                    ...
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/fashion`}
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/furniture`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/kids`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/pets`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/vegetables`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/watch`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/beauty`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/electronic`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/collection`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/right-sidebar/collection`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/no-sidebar/collection`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/metro/collection`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/full-width/collection`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/right-sidebar/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/no-sidebar/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/col-left/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/col-right/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/accordian/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/column/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/left-image/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/right-image/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-sm-6 col-12 text-center demo-effects">
                                        <div className="set-position">
                                            ...
                                            <div className="demo-text">
                                                ...
                                                <div className="btn-group demo-btn" role="group"
                                                     aria-label="Basic example">
                                                    <Link to={`${import.meta.env.VITE_PUBLIC_URL}/vertical/product/1`}
                                                          className="btn new-tab-btn">Preview
                                                    </Link>
                                                </div>
                                            </div>

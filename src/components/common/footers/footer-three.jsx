                            ...
                            <div className="col-lg-3">
                                ...
                                <div className="footer-contant">
                                    <ul className="contact-details">
                                        <li>Glass &amp; Fusion Demo Store, Demo store India 345-659</li>
                            ...
                            <div className="col p-set">
                                <div className="footer-link">
                                    ...
                                    <div className="footer-contant">
                                        <ul>
                                            <li><Link
                                                to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/collection`}>womens</Link>
                                            </li>
                                            <li><Link
                                                to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/collection`}>clothing</Link>
                                            </li>
                                            <li><Link
                                                to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/collection`}>accessories</Link>
                                            </li>
                                            <li><Link
                                                to={`${import.meta.env.VITE_PUBLIC_URL}/left-sidebar/collection`}>featured</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>

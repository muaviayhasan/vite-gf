...
import CategoryMenuFive from './common/category-menus/menu-5';
import LoginModal from '../../features/login-modal';

import { showModal } from '../../../actions';
import { stickyHeaderHandler } from '../../../utils/utils';

class HeaderNineteen extends Component {
                    ...
                    <div className="container">
                        <div className="header-left">
                            ...
                            <Link  to={ `${import.meta.env.VITE_PUBLIC_URL}/`} className="logo">
                                <img src={ `${import.meta.env.VITE_PUBLIC_URL}/assets/images/demos/demo-20/logo.png` } alt="Molla Logo" width="105" height="25"/>
                            </Link>
                        </div>
                        ...
                        <div className="header-right">
                            ...
                            <div className="header-dropdown-link">
                                ...
                                <div className="account">
                                    <Link to={ `${import.meta.env.VITE_PUBLIC_URL}/shop/dashboard`} title="My account">
                                        <div className="icon">
                                ...
                                <div className="wishlist">
                                    <Link to={ `${import.meta.env.VITE_PUBLIC_URL}/shop/wishlist`} title="Wishlist">
                                        <div className="icon">
...
export default connect( mapStateToProps, { showModal } )( HeaderNineteen );
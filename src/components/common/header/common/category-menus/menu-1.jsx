    ...
    render() {
        ...
        return (
            <div className="dropdown category-dropdown">
                <Link to={ `${import.meta.env.VITE_PUBLIC_URL}/shop/sidebar/list`} className="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static" title="Browse Categories">
                    Browse Categories
                    { type === 3 ? 

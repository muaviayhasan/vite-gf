                            ...
                            <ul className="top-menu">
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li className="login">
                                            <Link to="#signin-modal" data-toggle="modal" onClick={ this.openLoginModal }>Sign in / Sign up</Link>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <div className="header-middle">
                    <div className="container">
                        <div className="header-left">
                            ...
                            <Link  to={ `${import.meta.env.VITE_PUBLIC_URL}/`} className="logo">
                                <img src={ `${import.meta.env.VITE_PUBLIC_URL}/assets/images/demos/demo-13/logo.png` } alt="Molla Logo" width="105" height="25"/>
                            </Link>
                        </div>
                        ...
                        <div className="header-right">
                            <div className="header-dropdown-link">
                                ...
                                <Link to={ `${import.meta.env.VITE_PUBLIC_URL}/shop/wishlist`} className="wishlist-link">
...
export default connect( mapStateToProps, { showModal } )( HeaderSixteen );
...
class HeaderFifteen extends Component {
                        ...
                        <div className="row">
                            <div className="col-auto col-lg-3 col-xl-3 col-xxl-2">
                                ...
                                <Link  to={ `${import.meta.env.VITE_PUBLIC_URL}/`} className="logo">
                                    <img src={ `${import.meta.env.VITE_PUBLIC_URL}/assets/images/demos/demo-14/logo.png` } alt="Molla Logo" width="105" height="25"/>
                                </Link>
                            </div>
...
export default connect( mapStateToProps, { showModal } )( HeaderFifteen );